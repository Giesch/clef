...
- [-] add media controls support on windows
  ...
  - [ ] get back on mainline souvlaki
    - [ ] test this branch on linux
      - [ ] make sure features are set up and I didn't break anything
      - [ ] make sure new souvlaki didn't break anything
...
- [ ] figure out why hover is slow again after version update
